...
- (instancetype)initWithFrame:(CGRect)frame normalImages:(NSArray *)normalImages selectedImages:(NSArray *)selectedImages effectsType:(NSArray *)effectsType autoIndex:(int)index titleOnClick:(STTitleOnClickBlock)onClickBlock {
    
    return [self initWithFrame:frame normalImages:normalImages selectedImages:selectedImages titles:nil autoIndex:index  effectsType:effectsType titleOnClick:onClickBlock];
}

- (instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titles effectsType:(NSArray *)effectsType autoIndex:(int)index titleOnClick:(STTitleOnClickBlock)onClickBlock {
    return [self initWithFrame:frame normalImages:nil selectedImages:nil titles:titles autoIndex:index effectsType:effectsType titleOnClick:onClickBlock];
}


- (instancetype)initWithFrame:(CGRect)frame normalImages:(NSArray *)normalImages selectedImages:(NSArray *)selectedImages titles:(NSArray *)titles  autoIndex:(int)index effectsType:(NSArray *)effectsType titleOnClick:(STTitleOnClickBlock)onClickBlock {
