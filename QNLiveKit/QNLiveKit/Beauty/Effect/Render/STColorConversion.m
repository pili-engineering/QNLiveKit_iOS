...
NSString *const KSTVertexShaderString = SHADER_STRING
(
...
NSString *const kSTYUVVideoRangeConversionForRGFragmentShaderString = SHADER_STRING
(
...
NSString *const kSTYUVFullRangeConversionForLAFragmentShaderString1 = SHADER_STRING
(
...
NSString *const kSTYUVFullRangeConversionForLAFragmentShaderString = SHADER_STRING
(
...
NSString *const kSTYUVVideoRangeConversionForLAFragmentShaderString = SHADER_STRING
(
varying highp vec2 textureCoordinate;
