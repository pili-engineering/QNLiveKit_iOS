...
@implementation QRotateAnimationViewConfigure

+ (instancetype)defaultConfigure {
    QRotateAnimationViewConfigure *configure = [[QRotateAnimationViewConfigure alloc] init];
...
@interface QRotateAnimationView ()

///默认配置
@property (nonatomic, strong) QRotateAnimationViewConfigure *defaultConfigure;
///是否开始动画
...
@implementation QRotateAnimationView
...
//MARK:JmoVxia---更新配置
- (void)updateWithConfigure:(void(^)(QRotateAnimationViewConfigure *configure))configBlock {
    if (configBlock) {
...
//MARK:JmoVxia---默认配置
- (QRotateAnimationViewConfigure *) defaultConfigure {
    if (_defaultConfigure == nil) {
        _defaultConfigure = [QRotateAnimationViewConfigure defaultConfigure];
    }
