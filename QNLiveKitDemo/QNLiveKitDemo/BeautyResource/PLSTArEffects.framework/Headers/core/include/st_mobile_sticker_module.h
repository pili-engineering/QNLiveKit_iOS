...
/// @brief 2D贴纸模块参数
typedef enum {
    ST_STICKER_PARAM_2D_STICKER_WEARING_POSITION_INT = 200,         ///< 贴纸位置
    ST_STICKER_PARAM_2D_STICKER_COUNTER_SIZE_INT = 201,             ///< 序列帧数量
    ST_STICKER_PARAM_2D_STICKER_ROTATION_CENTER_X_INT = 202,        ///< 旋转中心点X坐标
    ST_STICKER_PARAM_2D_STICKER_ROTATION_CENTER_Y_INT = 203,        ///< 旋转中心点Y坐标
    ST_STICKER_PARAM_2D_STICKER_ANCHOR_POINT_X_INT = 204,           ///< 贴纸锚点位置X坐标
    ST_STICKER_PARAM_2D_STICKER_ANCHOR_POINT_Y_INT = 205,           ///< 贴纸锚点位置Y坐标
    ST_STICKER_PARAM_2D_STICKER_X_ANCHOR_KEY_INDEX_INT_ARRAY = 206, ///< 对应人脸点索引, int数组
    ST_STICKER_PARAM_2D_STICKER_Y_ANCHOR_KEY_INDEX_INT_ARRAY = 207, ///< 对应人脸点索引, int数组
    ST_STICKER_PARAM_2D_STICKER_X_SCALE_STANDARD_FLOAT = 208,       ///< 放缩标准距离
    ST_STICKER_PARAM_2D_STICKER_X_SCALE_KEY_INDEX_INT_ARRAY = 209,  ///< 对应人脸放缩点索引, int数组
    ST_STICKER_PARAM_2D_STICKER_Y_SCALE_STANDARD_FLOAT = 210,       ///< 放缩标准距离
    ST_STICKER_PARAM_2D_STICKER_Y_SCALE_KEY_INDEX_INT_ARRAY = 211,  ///< 对应人脸放缩点索引, int数组,
    ST_STICKER_PARAM_2D_STICKER_POSITION_RELATION_TYPE_INT = 212,   ///< 跟随人脸还是固定位置
    ST_STICKER_PARAM_2D_STICKER_Z_DEPTH_INT = 213                   ///< 渲染层级
